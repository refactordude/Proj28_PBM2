...
**Plans**: 6 plans
- [ ] 06-01-PLAN.md — Apply REQUIREMENTS.md spec deviations + ROADMAP SC#3 reconciliation (ASK-V2-03/04/05 deviations per D-05/D-11/D-12/D-18)
- [ ] 06-02-PLAN.md — llm_resolver `request` extension + 4 caller updates + starter_prompts service port + picker macro `disable_auto_commit` kwarg (ASK-V2-05, ASK-V2-08; D-15, D-17, Pitfall 3)
- [ ] 06-03-PLAN.md — Ask + settings routers (GET /ask, POST /ask/query, POST /ask/confirm, POST /settings/llm) + main.py registration; root.py /ask stub deletion (ASK-V2-01, ASK-V2-02, ASK-V2-05, ASK-V2-06, ASK-V2-07; D-08, D-10, D-13, D-14, D-16, Pitfalls 1, 4, 6)
- [ ] 06-04-PLAN.md — 5 ask templates (index, _starter_chips, _confirm_panel, _answer, _abort_banner) + LLM dropdown + Phase 6 CSS appendix (.ai-chip) (ASK-V2-01..03, -05, -07, -08; D-01..D-04, D-06, D-07, D-11, D-18; verbatim v1.0 UI-SPEC copy port)
...
| 6. Ask Tab Port | v2.0 | 0/6 | Not started | - |
